...
const LandingPage = () => {
  const features = [
    ...
    },
    {
      ...
      desc: 'Patients compare medicine prices across multiple pharmacies to save money.',
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section style={{
        ...
        <div className="animate-fade-in-up" style={{ position: 'relative', zIndex: 1, maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            marginBottom: '24px', fontSize: '0.8rem', color: '#5eead4', fontWeight: 600
          }}>
          ...
          <p style={{
            ...
            A complete hospital management solution — from appointment booking to prescriptions, 
            medicine comparison to multi-clinic admin. Built for modern healthcare.
          </p>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            {[
              ...
              { role: 'Patient', emoji: '🙋', desc: 'Book appointments, compare medicine prices, view history.', color: '#f59e0b' },
            ].map((r, i) => (
